...
namespace GoogleFormClient;

/// <summary>
/// Client to communicate with google forms.
/// </summary>
public interface IGoogleFormClient
{
    /// <summary>
...
/// <summary>
/// <see cref="IGoogleFormClient"/>
/// </summary>
public class GoogleFormClient : IGoogleFormClient
{
    ...
    /// <summary>
    /// Create a new instance of <see cref="GoogleFormClient"/>
    /// </summary>
    /// <param name="httpClient"><see cref="HttpClient"/></param>
    /// <param name="googleFormParser"><see cref="IGoogleFormParser"/></param>
    /// <exception cref="ArgumentNullException">http clients is null or googleFormParser is null</exception>
    public GoogleFormClient(HttpClient httpClient, IGoogleFormParser googleFormParser)
    {
